    ...
    <div className="contenido">
      <header className="header">
        ...
        <div className="barra" id="barra">
          ...
          <img
            className="img"
            src="https://highxtar.com/wp-content/uploads/2022/09/highxtar-este-es-el-icono-de-perfil-de-netflix-mas-utilizado-destacada.jpg"
            alt="Profile"
          />
          <button className="triangulo">
